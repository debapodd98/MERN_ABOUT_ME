    ...
    <>
      <div className='contact_info'>
        <div className='container-fluid'>
          <div className='row'>
            <div className='col-lg-10 offset-lg-1 d-flex flex-lg-row flex-column justify-content-between align-items-between'>
              ...
              <div className='contact_info_item d-flex flex-row align-items-center justify-content-start'>
                ...
                <div className='contact_info_content'>
                  ...
                  <div className='contact_info_text'>+919861099298</div>
                </div>
              </div>
              <div className='contact_info_item d-flex flex-row align-items-center justify-content-start'>
                <div className='contact_info_image'>
              ...
              <div className='contact_info_item d-flex flex-row align-items-center justify-content-start'>
                ...
                <div className='contact_info_content'>
                  ...
                  <div className='contact_info_text'>
                    Baksara Faridpur Block Howrah, West Bengal
                  </div>
                </div>
              </div>
              {/* </div> */}
          ...
          <div className='row'>
            <div className='col-lg-10 offset-lg-1 py-5'>
              ...
              <form method='POST' id='contact_form'>
                <div className='contact_form_inputs d-flex justify-content-between align-items-between'>
                  <input
                    type='text'
